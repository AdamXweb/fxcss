...
fxcss is [on PyPI](https://pypi.org/project/fxcss/). The tidiest way, which
keeps it and its one dependency out of your other Python environments:
...
```bash
python3 -m pip install "fxcss[images]"
```
